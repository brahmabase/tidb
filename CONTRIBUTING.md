...
- TiDB: https://github.com/brahmabase/tidb
- TiKV: https://github.com/tikv/tikv
- TiSpark: https://github.com/brahmabase/tispark
- PD: https://github.com/brahmabase/pd
- Docs: https://github.com/brahmabase/docs
- Docs-cn: https://github.com/brahmabase/docs-cn
...
The `c385cbdcca83eeed283139814a7ea149e3116e66` can be changed to any other commit hash. Try the latest commit hash [here]()
...
1. Visit https://github.com/brahmabase/tidb
...
working_dir=$GOPATH/src/github.com/brahmabase
```

> If you already worked with Go development on github before, the `brahmabase` directory
...
cd $working_dir/tidb
git remote add upstream https://github.com/brahmabase/tidb.git
# or: git remote add upstream git@github.com:brahmabase/tidb.git
...
# upstream  https://github.com/brahmabase/tidb (fetch)
...
See the [Commit Message and Pull Request Style]()
